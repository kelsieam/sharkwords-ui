...
const generateLetterButtons = () => {
  ...
  letterButtons.insertAdjacentHTML('beforeend',
...
const disableLetterButton = (buttonEl) => {
  var buttonEl = document.getElementById('letterButtons'); // Replace 'myButton' with the actual id of your button element
